  ...
  return (
    <section id="tophotel" className="section-padding pt-5 md:pt-10 w-full">
        ...
        <div className="mt-10 flex justify-center items-center">
            <a href="/hotel" className="border-1 mb-3 flex justify-center items-center rounded hover:bg-white-50 bg-transparent hover:text-black-50 transition border-white-50 py-2 px-4 contact-btn group">
