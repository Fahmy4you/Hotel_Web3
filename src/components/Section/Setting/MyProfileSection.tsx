...
const MyProfileSection = () => {
  ...
  // Handler untuk save/update profile
  ...
  return (
    <div className="p-6 overflow-hidden h-screen dark:bg-neutral-900 bg-white rounded-lg shadow-sm border dark:border-neutral-700 border-gray-200">
      <div className="flex flex-col md:flex-row gap-8">
        {/* Profile Picture Section */}
        <div className="flex flex-col items-center space-y-4">
          <div className="relative">
            <div className="w-40 h-40 rounded-full overflow-hidden border-4 border-white dark:border-neutral-700 shadow-md">
              <img
            ...
            <button
              ...
              className="absolute bottom-2 right-2 bg-white dark:bg-neutral-700 p-2 rounded-full shadow-md hover:bg-gray-100 dark:hover:bg-neutral-600 transition-colors duration-200"
            >
              <MdOutlinePhotoCamera size={20} className="text-gray-700 dark:text-white" />
            </button>
          </div>

          <div className="text-center">
            <h3 className="text-xl font-bold text-gray-900 dark:text-white">{user?.nama_user ?? ''}</h3>
        ...
        <div className="flex-1 space-y-6">
              ...
              {isEditing ? (
                <>
                  <button
                    ...
                    className="px-4 py-2 text-sm font-medium rounded-md border border-gray-300 dark:border-neutral-600 text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-neutral-700 transition-colors duration-200"
                  >
                    Batal
                  </button>
                  <button
                ...
                <button
                  ...
                  className="px-4 py-2 text-sm font-medium rounded-md bg-neutral-800 dark:bg-white dark:text-neutral-800 text-white hover:bg-neutral-900 dark:hover:bg-gray-100 transition-colors duration-200 flex items-center gap-2"
                >
                  <FaPencil size={20}/>
                  Edit Profil
                </button>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 rounded-md border border-gray-300 dark:border-neutral-600 
                    ...
                    disabled:bg-gray-100 dark:disabled:bg-neutral-800 disabled:text-gray-500 dark:disabled:text-gray-400
              ...
              {/* Wallet Address (Disabled since not supported by API) */}
              <div>
                <label
                  htmlFor="wallet"
                  className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1"
              ...
              {/* Join Date (Disabled since not supported by API) */}
              <div className="md:col-span-2">
                ...
                <textarea
                  ...
                  className="w-full px-3 py-2 rounded-md border border-gray-300 dark:border-neutral-600 
                    bg-gray-100 dark:bg-neutral-800 text-gray-500 dark:text-gray-400
                    cursor-not-allowed transition-colors duration-200 resize-none"
                />
              </div>
            </div>
          </div>
